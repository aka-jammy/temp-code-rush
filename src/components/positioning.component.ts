                   ...
                   <div class="relative bg-zinc-900/40 backdrop-blur-md border border-zinc-800 rounded-xl p-6 hover:border-violet-500/30 hover:bg-zinc-900/60 transition-all group overflow-hidden flex flex-col">
                      ...
                      <div class="flex justify-between items-start mb-4">
                         ...
                         <span class="text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider border shrink-0" 
                               [class.bg-emerald-500-10]="company.matchLevel === 'High'"
                               [class.text-emerald-400]="company.matchLevel === 'High'"
                               [class.border-emerald-500-20]="company.matchLevel === 'High'"
                               [class.bg-amber-500-10]="company.matchLevel === 'Medium'"
                               [class.text-amber-400]="company.matchLevel === 'Medium'"
                               [class.border-amber-500-20]="company.matchLevel === 'Medium'">
                            {{ company.matchLevel }} Match
                         </span>
                      </div>

                      <!-- Details Grid -->
                      <div class="grid grid-cols-2 gap-4 mb-4 bg-black/20 p-3 rounded-lg border border-zinc-800/50">
                        <div>
